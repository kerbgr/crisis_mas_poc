...
The `agent_network.png` visualization is **dynamically generated** when the system runs. If you see an outdated visualization showing only 3 agents instead of the current 13 expert agents, you need to regenerate it.

## Quick Regeneration

Run the provided script to generate the updated 13-expert network visualization:
...
**Output:**
- File: `results/visualizations/agent_network_13_experts.png`
- Shows all 13 expert agents with hierarchical trust relationships
...
- **Environmental Expert** - Environmental impact assessment
...
# With all 13 expert agents manually
...
- **v0.8** (Nov 2025): Expanded to 13 expert agents with hierarchical command structure

...
def resolve_disagreement(question, expert_ratings, get_third_expert_answer=None):
    """
    ...
    Args:
        ...
        get_third_expert_answer: callable(question) -> str, forwarded to
            resolve_with_tiebreaker() if a factual disagreement is routed
            to a tie-breaker.
    ...
    if confidence_delta > 0.3:
        ...
        if get_third_expert_answer is None:
            raise ValueError(
                "resolve_disagreement() routed to the tie-breaker strategy but "
                "no get_third_expert_answer callback was supplied."
            )
...
if __name__ == "__main__":
    demo_ratings = [
        ...
        {"expert": "B", "answer": "Defend", "confidence": 0.6, "quality": 4},
    ]
    resolve_disagreement(
        "Should we evacuate or defend the structure?",
        demo_ratings,
    )

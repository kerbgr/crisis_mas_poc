...
Usage example combining Cohen's Kappa (pairwise) and Fleiss' Kappa
(all raters) over a real expert_ratings.csv export with columns
expert_a_quality / expert_b_quality / expert_c_quality.
"""
...
def analyze_pairwise_and_group_kappa(ratings_csv="expert_ratings.csv"):
    ...
    return {"kappa_ab": kappa_ab, "kappa_ac": kappa_ac, "kappa_bc": kappa_bc, "fleiss_k": fleiss_k}


if __name__ == "__main__":
    analyze_pairwise_and_group_kappa()

...
At the agent level, the Civil Protection Director (GOLD) achieves the highest mean reliability across all scenarios (0.697), followed by the Coast Guard Strategic Commander (0.695) and the Strategic Fire Commander (0.690). The Environmental Scientist (0.347) and the Coast Guard On-Scene Tactical (0.380) score lowest, consistent with their more peripheral roles across the evaluated scenario portfolio. GOLD-level agents average 0.668 versus 0.571 for SILVER-level agents - a +9.7 pp advantage that reflects the GOLD agents' broader coordination mandate across all crisis types. Domain-conditional analysis reveals meaningful specialisation: the Civil Protection Director leads in both the Flood scenario (0.736) and the HAZMAT scenario (0.712), while the Fire-Brigade Tactical specialist leads in the Wildfire scenario (0.518) - the latter's comparatively lower absolute score reflecting the greater difficulty of the 12-alternative Evia action space. The Medical Expert (SILVER-Tactical) achieves 0.678 in the HAZMAT scenario, confirming the expected domain alignment between agent specialisation and reliability performance.
